...
<body>
        ...
        <div class="row">
            ...
            <div class="th-text pull-right">
                ...
                <div class="social-icons"> 
                    <a href="https://www.facebook.com/share/1BhMiDsieH/"><i class="fa fa-facebook"></i></a> 
                    <a href="http://www.twitter.com/"><i class="fa fa-twitter"></i></a> 
                    <a href="https://www.instagram.com/iberrywifi_security?igsh=bjE1MnFjdXhsNTM="><i class="fa fa-instagram"></i></a> 
                </div>
                </div>
            </div>
            </div>
    ...
    <header>
        ...
        <div class="container">
            ...
            <!-- Logo -->
            <div id="logo"> 
                <img id="default-logo" src="images/iberry-logo.webp" alt="Iberry WiFi Security" style="height:55px;"> 
                <img id="retina-logo" src="images/iberry-logo.webp" alt="Iberry WiFi Security" style="height:84px; width: 120px; margin-top: -15px;"> </div>
            </a> </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <!-- login and install -->
          <li class="navbar-login-link"> <a href="https://ibudha.com/dev/mikifi/login" title="Login ibudha"><i class="fa fa-sign-in" style="font-size: 18px;"></i></a>
          <li class="navbar-login-link"> <a href="http://iberrywifi.com/uploads/ibudha_app.apk" title="Install the App"><i class="fa fa-download" style="font-size: 18px;"></i> <!-- Install Icon --></a></li>
                </li>
                <li style="height:80px;"><a href="https://www.google.com/maps/place/Iberry+Wifi+Corporation/@30.7371149,76.6781289,17z/data=!3m1!4b1!4m6!3m5!1s0x390fef200cac8599:0x470654270ca2bc93!8m2!3d30.7371149!4d76.6807038!16s%2Fg%2F11ghnbw2q4?hl=en-US&entry=ttu&g_ep=EgoyMDI1MDEwNy4wIKXMDSoASAFQAw%3D%3D"> <img class="location" src="images/2.webp" alt="Iberry WiFi Security Office" title="Iberry WiFi Office"></a></li>
            </ul>
            </div>
        </div>
        </div>
                    ...
                    <div class="widget widget-author">
                        ...
                        <div class="widget-body">
                            <div class="media align-items-center">
                                <div class="avatar">
                                    <img src="images/iberry-logo.webp" alt="Author Avatar">
                                </div>
                                <div class="media-body">
