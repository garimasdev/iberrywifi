    ...
    <header>
        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="navbar-login-link"> <a href="https://ibudha.com/dev/mikifi/login">Login</a> </li>
          <li class="navbar-install-link"> 
            <a href="https://iberrywifi.com/uploads/ibudha_app.apk" id="install-icon" title="Install the App">
              <i class="fa fa-download" style="font-size: 20px;"></i> <!-- Install Icon -->
            </a>
          </li>
                </li>
